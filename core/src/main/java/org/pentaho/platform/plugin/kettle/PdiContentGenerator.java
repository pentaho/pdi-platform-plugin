...
public class PdiContentGenerator extends FileResourceContentGenerator {
  ...
  protected StringBuffer formatMessage( String imgPath, String heading, String descriptions ) {
    ...
    messageBuffer.append( "<html>" )
            ...
            .append( "  </head>" )
            .append( "  <body style='width: 100%; height: 100%; display: flex; justify-content: center; align-items: center;'>" )
            .append( "    <div style='margin: auto; width: 410px; display: flex; padding: 30px;'>" )
